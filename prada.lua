...
-- FULL PINK EDITION STANDALONE UI (KAWAII REVAMPED) --
...
["Invincible"] = {["DisplayDescription"] = "Makes you invisible & god mode (you can still use abilities)", ["DisplayTitle"] = "Invincible", ["LayoutOrder"] = 1, ["Savable"] = false, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = "hookmetamethod|require|OfficialGame"}, ["ScriptFunction"] = function(self, Value)
...
["DisableKillerWalls"] = {["DisplayDescription"] = "Disables All Killer Walls (Red Walls)", ["DisplayTitle"] = "Disable Killer Walls", ["LayoutOrder"] = 2, ["Savable"] = false, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = true}, ["ScriptFunction"] = function(self, Value)
...
["DisableToxicTrails"] = {["DisplayDescription"] = "Disables damaging trails for john doe", ["DisplayTitle"] = "Disable John Doe's Trails", ["LayoutOrder"] = 3, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {}, ["ScriptFunction"] = function(self, Value)
...
["DisableFootprints"] = {["DisplayDescription"] = "Disables footprints made by john doe", ["DisplayTitle"] = "Disable John Doe's Footprints", ["LayoutOrder"] = 4, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {}, ["ScriptFunction"] = function(self, Value)
for i,v in InGame:GetChildren() do
...
["SmallerSpikeCollisions"] = {["DisplayDescription"] = "Makes spike collisions smaller for john doe's ability", ["DisplayTitle"] = "Smaller Spike Collisions", ["LayoutOrder"] = 5, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {}, ["ScriptFunction"] = function(self, Value)
for i,v in InGame:GetChildren() do
...
["NoliControl"] = {["DisplayDescription"] = "Allows you to have better control of Void Rush Ability", ["DisplayTitle"] = "Better Void Rush", ["LayoutOrder"] = 11, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = "require"}, ["ScriptFunction"] = function(self, Value)
if NoliConfig then
for _, Entry in {{Name = "InitialTurnDuration", Value = 0.005, Default = 1.5}, {Name = "TurnSpeed", Value = 10000, Default = 1}, {Name = "InitialTurnMult", Value = 1000, Default = 6.6}} do
...
["Disable007n7NPC"] = {["DisplayDescription"] = "Disables 007n7's Distracting NPC", ["DisplayTitle"] = "Disable 007n7's NPC", ["LayoutOrder"] = 1, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {}, ["ScriptFunction"] = function(self, Value) Handle007n7NPC(Value) end},
["ESP"] = {["DisplayDescription"] = "Track things in the game through walls", ["DisplayTitle"] = "ESP", ["LayoutOrder"] = 2, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {}, ["ScriptFunction"] = function(self, Value) end},
["KillersESP"] = {["DisplayDescription"] = "Enables ESP for the killer(s)", ["DisplayTitle"] = "Killer(s) (ESP)", ["LayoutOrder"] = 3, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = "ESP"}, ["ScriptFunction"] = function(self, Value) end},
["KillersColor"] = {["DisplayDescription"] = "Select a Color for Killer(s) (ESP)", ["DisplayTitle"] = "Killer(s) Color", ["LayoutOrder"] = 4, ["Savable"] = true, ["InstanceType"] = "StringValue", ["DefaultInstanceValue"] = "Red", ["ExtraData"] = {["Requirement"] = "ESP|KillersESP", ["Options"] = "Red|Orange|Purple|Gold"}, ["ScriptFunction"] = function(self, Value)
local Name = "Killer(s) "
...
["SurvivorsColor"] = {["DisplayDescription"] = "Select a Color for Survivor(s) (ESP)", ["DisplayTitle"] = "Survivor(s) Color", ["LayoutOrder"] = 7, ["Savable"] = true, ["InstanceType"] = "StringValue", ["DefaultInstanceValue"] = "Green", ["ExtraData"] = {["Requirement"] = "ESP|SurvivorsESP", ["Options"] = "Green|Orange|Purple|Gold"}, ["ScriptFunction"] = function(self, Value)
...
["GeneratorsColor"] = {["DisplayDescription"] = "Select a Color for Generator(s) (ESP)", ["DisplayTitle"] = "Generator(s) Color", ["LayoutOrder"] = 10, ["Savable"] = true, ["InstanceType"] = "StringValue", ["DefaultInstanceValue"] = "Cyan", ["ExtraData"] = {["Requirement"] = "ESP|GeneratorsESP", ["Options"] = "Cyan|Blue|Green|Orange|Purple|Gold"}, ["ScriptFunction"] = function(self, Value)
...
["ItemsColor"] = {["DisplayDescription"] = "Select a Color for Item(s) (ESP)", ["DisplayTitle"] = "Item(s) Color", ["LayoutOrder"] = 13, ["Savable"] = true, ["InstanceType"] = "StringValue", ["DefaultInstanceValue"] = "Gold", ["ExtraData"] = {["Requirement"] = "ESP|ItemsESP", ["Options"] = "Gold|Cyan|Purple|White"}, ["ScriptFunction"] = function(self, Value)
local Name = "Item(s) "
local H, S, V = ColorPresets[Value]:ToHSV()
local Color = ColorPresets[Value]
local DarkerColor = Color3.fromHSV(H, S, V * 0.7)
...
["ExtendedFOV"] = {["DisplayDescription"] = "A extended version of the FOV inside the normal settings", ["DisplayTitle"] = "Extended FOV", ["LayoutOrder"] = 1, ["Savable"] = true, ["InstanceType"] = "NumberValue", ["DefaultInstanceValue"] = PlayerData.Settings.Game.FieldOfView.Value, ["ExtraData"] = {["MaxValue"] = 120, ["MinValue"] = 10, ["Step"] = 5}, ["ScriptFunction"] = function(self, Value) PlayerData.Settings.Game.FieldOfView.Value = Value end},
["ExtendedZoom"] = {["DisplayDescription"] = "Extends the Maximum Zoom Distance for the camera", ["DisplayTitle"] = "Extended Zoom Distance", ["LayoutOrder"] = 2, ["Savable"] = true, ["InstanceType"] = "NumberValue", ["DefaultInstanceValue"] = 10, ["ExtraData"] = {["MaxValue"] = 100, ["MinValue"] = 0, ["Step"] = 5}, ["ScriptFunction"] = function(self, Value) LocalPlayer.CameraMaxZoomDistance = game:GetService("StarterPlayer").CameraMaxZoomDistance + (Value * 0.25) end},
["ShowChat"] = {["DisplayDescription"] = "Shows the Full Chat while in the Round", ["DisplayTitle"] = "Show Chat", ["LayoutOrder"] = 3, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = not game:GetService("Chat"):CanUserChatAsync(LocalPlayer.UserId) and true or nil}, ["ScriptFunction"] = function(self, Value) if TextChatService:FindFirstChildOfClass("ChatWindowConfiguration") then TextChatService:FindFirstChildOfClass("ChatWindowConfiguration").Enabled = Value end end},
["ShowPrivacy"] = {["DisplayDescription"] = "Shows everyones privacy info", ["DisplayTitle"] = "Shows Privacy Info", ["LayoutOrder"] = 4, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {}, ["ScriptFunction"] = function(self, Value) for i,v in Players:GetPlayers() do if v ~= LocalPlayer then HandlePrivacySettings(v) end end end},
["HideInjury"] = {["DisplayDescription"] = "Hides the injured screen and effects used when you are low health", ["DisplayTitle"] = "Hide Injured UI/Effects", ["LayoutOrder"] = 5, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = true, ["ExtraData"] = {}, ["ScriptFunction"] = function(self, Value) for i,v in PlayerGui:FindFirstChild("TemporaryUI"):QueryDescendants("#redFlash,#injuredVignette") do v.Visible = not Value end if game:GetService("Lighting"):FindFirstChild("HealthDesaturation") then game:GetService("Lighting"):FindFirstChild("HealthDesaturation").Enabled = not Value end end},
["DeleteRagdolls"] = {["DisplayDescription"] = "Deletes ALL Ragdolls regardless the type of ragdoll for performance", ["DisplayTitle"] = "Delete All Ragdolls", ["LayoutOrder"] = 6, ["Savable"] = true, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = "PrivateServer"}, ["ScriptFunction"] = function(self, Value) if workspace:FindFirstChild("Ragdolls") and Value then workspace:FindFirstChild("Ragdolls"):ClearAllChildren() end end},
...
["CrashTheTarget"] = {["DisplayDescription"] = "Crashes the selected target (Host Exclusive)", ["DisplayTitle"] = "Crash Target", ["LayoutOrder"] = 9, ["Savable"] = false, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = "PlayerSelectCrash~None|PrivateServerOwner"}, ["ScriptFunction"] = function(self, Value)
if Value then
...
task.spawn(function() repeat Network:WaitForChild("RemoteEvent"):FireServer("ExecuteCommand", {"GiveStatus", Name, "Nausea", math.huge, 1}) task.wait(1.5) until not Players:FindFirstChild(Name) end)
end
end
else
task.spawn(function() repeat Network:WaitForChild("RemoteEvent"):FireServer("ExecuteCommand", {"GiveStatus", PlayerName, "Nausea", math.huge, 1}) task.wait(1.5) until not Players:FindFirstChild(PlayerName) end)
end
end
end},
["SkyGlitch"] = {["DisplayDescription"] = "Gives sky glitching effect to everyone (Host Exclusive)", ["DisplayTitle"] = "Sky Glitch", ["LayoutOrder"] = 10, ["Savable"] = false, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = "PrivateServerOwner"}, ["ScriptFunction"] = function(self, Value)
...
task.delay(10, function() workspace:SetAttribute("EffectActive",nil) self.Instance.Value = false end)
elseif workspace:GetAttribute("EffectActive") then self.Instance.Value = true end
end},
["InstaKill"] = {["DisplayDescription"] = "Allows you to instantly kill anyone (Host Exclusive)", ["DisplayTitle"] = "Instant Kill", ["LayoutOrder"] = 11, ["Savable"] = false, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = "PrivateServerOwner"}, ["ScriptFunction"] = function(self, Value)
...
["OfficialJoin"] = {["DisplayDescription"] = "Makes you join the official forsaken game", ["DisplayTitle"] = "Join the official version", ["LayoutOrder"] = 14, ["Savable"] = false, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {["Requirement"] = "OfficialGame~true"}, ["ScriptFunction"] = function(self, Value)
...
elseif workspace:GetAttribute("LoadingTeleport") then self.Instance.Value = true end
end},
["Rejoin"] = {["DisplayDescription"] = "Makes you rejoin the exact same server", ["DisplayTitle"] = "Rejoin", ["LayoutOrder"] = 15, ["Savable"] = false, ["InstanceType"] = "BoolValue", ["DefaultInstanceValue"] = false, ["ExtraData"] = {}, ["ScriptFunction"] = function(self, Value)
if Value and not workspace:GetAttribute("LoadingTeleport") then
workspace:SetAttribute("LoadingTeleport",true)
local A = workspace:FindFirstChild("Sounds") and workspace.Sounds:ClearAllChildren()
local B = workspace:FindFirstChild("Themes") and workspace.Themes:ClearAllChildren()
...
Tween.Parent = Highlight; Tween:Play(); Debris:AddItem(Tween, 0.1)
else
...
Highlight.Parent = ItemInstance; Highlight.Adornee = ItemInstance
Highlight.FillTransparency = 1; Highlight.OutlineTransparency = 1
...
for i,v in Players:GetPlayers() do if v ~= LocalPlayer then OriginString = OriginString .. "|" .. v.Name end end
...
Connection:Disconnect(); LocalHumanoid.JumpPower = LocalHumanoid:GetAttribute("JumpingConnection") or 0; LocalHumanoid:SetAttribute("JumpingConnection",nil); return
end
...
v.Parent = Lighting; v:PivotTo(v:GetPivot() * CFrame.new(0,-100,0))
end
end
...
for i,v in Lighting:GetChildren() do if v.Name:lower() == "007n7" then v.Parent = InGame end end
end
end
...
IsUnderground = true; task.wait(0.02); LocalHead.Anchored = false; LocalRoot.CFrame = OldCFrame
until IsHitboxNotNear(LocalCharacter:FindFirstChild("QueryHitbox"),OldCFrame.Position) or Tries >= 3
if Tries >= 3 then
IsUnderground = false; workspace:SetAttribute("Invincible",nil)
FeatureLoadout["Features"]["Invincible"]["Instance"].Value = false; task.wait(0.03)
...
task.wait(0.1); LocalHumanoid.CameraOffset = Vector3.new(0, 0, 0)
...
for i2,v2 in animId do if type(v2) == "string" and v2:find(tostring(ID)) then return animtype,i end end
else
...
Animation.Parent = OverrideFolder; Animation:SetAttribute("Overriden",true)
local Animator = LocalHumanoid and LocalHumanoid:FindFirstChildOfClass("Animator")
if Animator then
...
OverrideTrack.Looped = Track.Looped; OverrideTrack:Play(SkipOverride and 0 or 0.1); Track:Stop(0)
...
if AnimationPreset.Value == "Original" then OverrideTrack:Stop(); LastTrack:Play() else OverrideTrack:Stop() end
end)
end
end
end
...
if isfile("NaikoScript/ForsakenPlus/" .. Path) ~= false then return ColoredPrint("Option already exists", "info", Color3.fromRGB(252, 210, 150))
else writefile("NaikoScript/ForsakenPlus/" .. Path, Option); return ColoredPrint("Set default data", "success", Color3.fromRGB(125, 230, 75)) end
end
...
else if isfile("NaikoScript/ForsakenPlus/" .. Path) ~= false then writefile("NaikoScript/ForsakenPlus/" .. Path, Option) end end
end

local function ReturnData(Path, WithFolder)
if WithFolder == false then if isfile(Path) ~= false then return readfile(Path) end
else if isfile("NaikoScript/ForsakenPlus/" .. Path) ~= false then return readfile("NaikoScript/ForsakenPlus/" .. Path) end; return nil end
end
...
FeatureLoadout["Outdated"] = {["TabAttributes"] = {["DisplayTitle"] = '<font color="rgb(255,166,0)">⚠</font>' .. RichTextGradientColor(" SCRIPT ISN'T TESTED FOR THIS GAME VERSION ",{Color3.fromRGB(255, 166, 0), Color3.fromRGB(243, 227, 0)}) .. '<font color="rgb(243, 227, 0)">⚠</font>', ["LayoutOrder"] = -2}}
...
FeatureLoadout["Unofficial"] = {["TabAttributes"] = {["DisplayTitle"] = "SOME FEATURES MAY NOT WORK HERE", ["LayoutOrder"] = -1}}
...
if ConfigModule.Parent.Name == "Noli" and ConfigData and TableValueFind(ConfigData, function(Key, Value) return type(Key) == "string" and Key:find("InitialTurnMult") end) then NoliConfig = ConfigData end
...
InfiniteStaminaElement.Name = "InfiniteAmount"; InfiniteStaminaElement.Text = "∞"; InfiniteStaminaElement.Parent = OriginalAmountUI.Parent
...
makefolder("NaikoScript"); makefolder("NaikoScript/ForsakenPlus"); UserType = 1
elseif isfolder("NaikoScript") and not isfolder("NaikoScript/ForsakenPlus") then
UserType = 2; makefolder("NaikoScript/ForsakenPlus")
elseif isfolder("NaikoScript") and isfolder("NaikoScript/ForsakenPlus") then UserType = 3 end
...
Folder.Name = TabName; Folder.Parent = PlusFolderSettings
...
NewInstance.Name = SettingName; NewInstance.Value = SettingData.DefaultInstanceValue
...
local DesyncerNum = 6e9; Args[4] = table.create(3)
...
if not IsFixingGenerator or not LocalCharacter or not SpeedMultipliers or not SpeedMultipliers:FindFirstChild("FixingGenerator") or not Automation["AutoGeneratorPuzzle"]["Instance"].Value then break end
RemoteEvent:FireServer(); PlaySound("puzzleDone", {["Parent"] = Object:FindFirstChild("Main")})
end
end
...
CreateDynamicHighlight((GetValue(v.Parent.Name.."ESP")), v, v:FindFirstChild("HumanoidRootPart"), {["MaxDistance"] = 100, ["MinDistance"] = 10, ["Color"] = ColorPresets[GetValue(v.Parent.Name.."Color")]})
else CreateDynamicHighlight(false, v) end
end
end
end,0.1)
...
if Data == "Start" then if GetValue("ShowChat") then TextChatService.ChatWindowConfiguration.Enabled = true end
else IsUnderground = false end
end)
...
v.FillTransparency = 0.9; v.OutlineTransparency = 0.9
end
end)
...
-- ==========================================
-- CUSTOM KAWAII PINK UI (Prada UI Edition)
-- ==========================================
local SG = Instance.new("ScreenGui")
SG.Name = "PradaKawaiiUI"
...
-- Colors
local Colors = {
BgMain = Color3.fromRGB(255, 250, 252),
BgSidebar = Color3.fromRGB(255, 240, 245),
BgItem = Color3.fromRGB(255, 255, 255),
Pink = Color3.fromRGB(255, 182, 193),
DarkPink = Color3.fromRGB(255, 105, 180),
Purple = Color3.fromRGB(216, 191, 255),
TextMain = Color3.fromRGB(80, 50, 80),
TextSub = Color3.fromRGB(150, 120, 150),
White = Color3.fromRGB(255, 255, 255),
Gray = Color3.fromRGB(230, 220, 230)
}
...
local s = Instance.new("UIStroke"); s.Color = color or Colors.Pink; s.Thickness = thickness or 1.5; s.Transparency = 0.2; s.Parent = parent; return s
end

local function CreateGradient(parent, c1, c2)
local g = Instance.new("UIGradient"); g.Color = ColorSequence.new(c1 or Colors.Pink, c2 or Colors.Purple); g.Rotation = 45; g.Parent = parent; return g
end

local function Tween(object, time, properties)
local t = TweenService:Create(object, TweenInfo.new(time or 0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), properties); t:Play(); return t
end
...
ToggleBtn.Text = "🎀 Prada UI"
ToggleBtn.AutoButtonColor = false
CreateCorner(ToggleBtn, 22)
CreateStroke(ToggleBtn, Colors.White, 2)

ToggleBtn.MouseEnter:Connect(function() Tween(ToggleBtn, 0.2, {BackgroundColor3 = Colors.DarkPink, Size = UDim2.new(0, 140, 0, 48)}) end)
ToggleBtn.MouseLeave:Connect(function() Tween(ToggleBtn, 0.2, {BackgroundColor3 = Colors.Pink, Size = UDim2.new(0, 130, 0, 45)}) end)
...
CreateStroke(MainFrame, Colors.Pink, 2)

-- Sparkle Particles for MainFrame
local Sparkles = Instance.new("ParticleEmitter", MainFrame)
Sparkles.Texture = "rbxassetid://6490035152"
Sparkles.Rate = 5
...
Sparkles.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0, 1), NumberSequenceKeypoint.new(0.5, 0.5), NumberSequenceKeypoint.new(1, 1)})
Sparkles.Color = ColorSequence.new(Colors.Pink, Colors.Purple)
...
TitleBar.BackgroundColor3 = Colors.White
TitleBar.BorderSizePixel = 0
CreateCorner(TitleBar, 15)
CreateGradient(TitleBar, Colors.Pink, Colors.Purple)

local FixBottom = Instance.new("Frame", TitleBar)
FixBottom.Size = UDim2.new(1, 0, 0.5, 0)
FixBottom.Position = UDim2.new(0, 0, 0.5, 0)
FixBottom.BackgroundColor3 = Colors.BgMain
...
CloseBtn.MouseEnter:Connect(function() Tween(CloseBtn, 0.2, {BackgroundTransparency = 0, BackgroundColor3 = Color3.fromRGB(255, 100, 100)}) end)
CloseBtn.MouseLeave:Connect(function() Tween(CloseBtn, 0.2, {BackgroundTransparency = 0.8, BackgroundColor3 = Color3.fromRGB(255, 255, 255)}) end)
...
TabContainer.BackgroundColor3 = Colors.BgSidebar
TabContainer.BorderSizePixel = 0
TabContainer.ScrollBarThickness = 0
TabContainer.AutomaticCanvasSize = Enum.AutomaticSize.Y
CreateCorner(TabContainer, 15)
...
isOpen = not isOpen
if isOpen then
MainFrame.Visible = true; MainFrame.BackgroundTransparency = 1; MainFrame.Size = UDim2.new(0, 600, 0, 380)
Tween(MainFrame, 0.3, {BackgroundTransparency = 0.05, Size = UDim2.new(0, 650, 0, 420)})
ToggleBtn.Text = "🎀 Close"
else
Tween(MainFrame, 0.2, {BackgroundTransparency = 1, Size = UDim2.new(0, 600, 0, 380)})
...
TabBtn.Text = displayName or tabName
...
TabBtn.MouseEnter:Connect(function() if currentTab ~= tabName then Tween(TabBtn, 0.2, {BackgroundTransparency = 0.5, BackgroundColor3 = Colors.Pink}) end end)
TabBtn.MouseLeave:Connect(function() if currentTab ~= tabName then Tween(TabBtn, 0.2, {BackgroundTransparency = 1, BackgroundColor3 = Colors.White}) end end)
...
for _, child in pairs(TabContainer:GetChildren()) do if child:IsA("TextButton") then Tween(child, 0.2, {BackgroundTransparency = 1, BackgroundColor3 = Colors.White, TextColor3 = Colors.TextMain}) end end
Scroll.Visible = true
Tween(TabBtn, 0.2, {BackgroundTransparency = 0, BackgroundColor3 = Colors.Pink, TextColor3 = Colors.White})
currentTab = tabName
end)

if currentTab == nil then
Scroll.Visible = true; TabBtn.BackgroundTransparency = 0; TabBtn.BackgroundColor3 = Colors.Pink; TabBtn.TextColor3 = Colors.White; currentTab = tabName
end
return Scroll
end
...
Frame.Size = UDim2.new(1, -10, 0, 50); Frame.BackgroundColor3 = Colors.BgItem; Frame.BorderSizePixel = 0
CreateCorner(Frame, 10); CreateStroke(Frame, Colors.Gray, 1)

local Title = Instance.new("TextLabel", Frame)
Title.Size = UDim2.new(0.7, 0, 0.5, 0); Title.Position = UDim2.new(0, 12, 0, 6); Title.BackgroundTransparency = 1
Title.Text = titleText; Title.TextColor3 = Colors.TextMain; Title.Font = Enum.Font.FredokaOne; Title.TextSize = 14; Title.TextXAlignment = Enum.TextXAlignment.Left

local Desc = Instance.new("TextLabel", Frame)
Desc.Size = UDim2.new(0.7, 0, 0.4, 0); Desc.Position = UDim2.new(0, 12, 0.5, -4); Desc.BackgroundTransparency = 1
Desc.Text = descText or ""; Desc.TextColor3 = Colors.TextSub; Desc.Font = Enum.Font.GothamRounded; Desc.TextSize = 11; Desc.TextXAlignment = Enum.TextXAlignment.Left; Desc.TextTruncate = Enum.TextTruncate.AtEnd

local SwitchBg = Instance.new("Frame", Frame)
SwitchBg.Size = UDim2.new(0, 40, 0, 22); SwitchBg.Position = UDim2.new(1, -50, 0.5, -11)
SwitchBg.BackgroundColor3 = valueObj.Value and Colors.Pink or Colors.Gray; SwitchBg.BorderSizePixel = 0
CreateCorner(SwitchBg, 11)

local SwitchCircle = Instance.new("Frame", SwitchBg)
SwitchCircle.Size = UDim2.new(0, 18, 0, 18)
SwitchCircle.Position = valueObj.Value and UDim2.new(1, -20, 0.5, -9) or UDim2.new(0, 2, 0.5, -9)
SwitchCircle.BackgroundColor3 = Colors.White; SwitchCircle.BorderSizePixel = 0
CreateCorner(SwitchCircle, 9)
...
local isOn = valueObj.Value
Tween(SwitchBg, 0.2, {BackgroundColor3 = isOn and Colors.Pink or Colors.Gray})
Tween(SwitchCircle, 0.2, {Position = isOn and UDim2.new(1, -20, 0.5, -9) or UDim2.new(0, 2, 0.5, -9)})
for TabName, TabContents in pairs(FeatureLoadout) do
if TabContents[valueObj.Name] and TabContents[valueObj.Name].ScriptFunction then task.spawn(function() TabContents[valueObj.Name]:ScriptFunction(valueObj.Value) end) end
end
end)
...
local Title = Instance.new("TextLabel", Frame)
Title.Size = UDim2.new(0.6, 0, 0.5, 0); Title.Position = UDim2.new(0, 12, 0, 6); Title.BackgroundTransparency = 1
Title.Text = titleText; Title.TextColor3 = Colors.TextMain; Title.Font = Enum.Font.FredokaOne; Title.TextSize = 14; Title.TextXAlignment = Enum.TextXAlignment.Left

local Desc = Instance.new("TextLabel", Frame)
Desc.Size = UDim2.new(0.6, 0, 0.4, 0); Desc.Position = UDim2.new(0, 12, 0.5, -4); Desc.BackgroundTransparency = 1
Desc.Text = descText or ""; Desc.TextColor3 = Colors.TextSub; Desc.Font = Enum.Font.GothamRounded; Desc.TextSize = 11; Desc.TextXAlignment = Enum.TextXAlignment.Left; Desc.TextTruncate = Enum.TextTruncate.AtEnd

local CycleBtn = Instance.new("TextButton", Frame)
CycleBtn.Size = UDim2.new(0, 120, 0, 26); CycleBtn.Position = UDim2.new(1, -130, 0.5, -13)
CycleBtn.BackgroundColor3 = Colors.Pink; CycleBtn.Text = "◀ " .. tostring(valueObj.Value) .. " ▶"
CycleBtn.TextColor3 = Colors.White; CycleBtn.Font = Enum.Font.FredokaOne; CycleBtn.TextSize = 12; CycleBtn.AutoButtonColor = false
CreateCorner(CycleBtn, 13)
...
CycleBtn.Text = "◀ " .. tostring(valueObj.Value) .. " ▶"
for TabName, TabContents in pairs(FeatureLoadout) do
if TabContents[valueObj.Name] and TabContents[valueObj.Name].ScriptFunction then task.spawn(function() TabContents[valueObj.Name]:ScriptFunction(valueObj.Value) end) end
end
end)

valueObj.Changed:Connect(function() CycleBtn.Text = "◀ " .. tostring(valueObj.Value) .. " ▶" end)
end

local function CreateSlider(parent, titleText, descText, valueObj, min, max)
local Frame = Instance.new("Frame", parent)
Frame.Size = UDim2.new(1, -10, 0, 60); Frame.BackgroundColor3 = Colors.BgItem; Frame.BorderSizePixel = 0
CreateCorner(Frame, 10); CreateStroke(Frame, Colors.Gray, 1)

local Title = Instance.new("TextLabel", Frame)
Title.Size = UDim2.new(0.7, 0, 0.4, 0); Title.Position = UDim2.new(0, 12, 0, 6); Title.BackgroundTransparency = 1
Title.Text = titleText; Title.TextColor3 = Colors.TextMain; Title.Font = Enum.Font.FredokaOne; Title.TextSize = 14; Title.TextXAlignment = Enum.TextXAlignment.Left

local ValText = Instance.new("TextLabel", Frame)
ValText.Size = UDim2.new(0.2, 0, 0.4, 0); ValText.Position = UDim2.new(0.8, -10, 0, 6); ValText.BackgroundTransparency = 1
ValText.Text = tostring(valueObj.Value); ValText.TextColor3 = Colors.DarkPink; ValText.Font = Enum.Font.FredokaOne; ValText.TextSize = 14; ValText.TextXAlignment = Enum.TextXAlignment.Right

local SliderBar = Instance.new("TextButton", Frame)
SliderBar.Size = UDim2.new(1, -24, 0, 8); SliderBar.Position = UDim2.new(0, 12, 0.65, 0)
SliderBar.BackgroundColor3 = Colors.Gray; SliderBar.Text = ""; SliderBar.AutoButtonColor = false
...
Fill.BackgroundColor3 = Colors.Pink; CreateCorner(Fill, 4)

local Handle = Instance.new("Frame", Fill)
Handle.Size = UDim2.new(0, 16, 0, 16); Handle.Position = UDim2.new(1, -8, 0.5, -8)
Handle.BackgroundColor3 = Colors.White; Handle.BorderSizePixel = 0
CreateCorner(Handle, 8); CreateStroke(Handle, Colors.Pink, 2)
...
SliderBar.InputBegan:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then isDragging = true; updateSlider(input) end end)
Handle.InputBegan:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then isDragging = true end end)
...
local r = max - min; if r == 0 then r = 1 end
Tween(Fill, 0.1, {Size = UDim2.new(math.clamp((valueObj.Value - min)/r, 0, 1), 0, 1, 0)})
end)
end

-- Build UI from FeatureLoadout
local sortedTabs = {}
for TabName, TabContents in pairs(FeatureLoadout) do
if TabName ~= "Outdated" and TabName ~= "Unofficial" then
...
["Visuals"] = "👁️ Visuals",
["Miscellaneous"] = "🔮 Misc",
["ExploitFunctions"] = "💻 System"
}

for _, tabInfo in ipairs(sortedTabs) do
local TabName = tabInfo.name
local TabContents = FeatureLoadout[TabName]
local displayName = tabDisplayNames[TabName] or TabName
local scroll = CreateTab(TabName, displayName)
...
dTitle = dTitle:gsub("<[^>]+>", ""); dDesc = dDesc:gsub("<[^>]+>", "")
...
ColoredPrint("Prada Kawaii UI has loaded successfully! 🌸", "success", Colors.Pink)